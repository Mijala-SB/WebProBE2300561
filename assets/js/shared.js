...
const Auth = {
  ...
  logout: (redirectTo) => { Auth.clear(); window.location.href = redirectTo || '../index.php'; },
...
function redirectIfLoggedIn() {
  ...
  if (!role) return;
  const map = { student: 'student/dashboard.php', provider: 'provider/dashboard.php', admin: 'admin/dashboard.php' };
