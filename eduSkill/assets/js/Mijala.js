  ...
  list.innerHTML = PENDING_PROVIDERS.map(p => `
    <div class="appr-card">
      ...
      <div class="appr-actions">
        <button class="btn-outline" style="font-size:.8rem;padding:7px 14px" onclick="typeof viewPendingProvider==='function'?viewPendingProvider(${p.id}):handleApproval(${p.id},'approve')"><i class="fas fa-eye"></i> View Details</button>
